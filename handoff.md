...
- 2026-06-04 wrap-up:
  ...
  - Added `/api/ai-budget` and `/api/sync-selected-project` to `host_router.py`. AI sync is now internal-token-only for automation; browser/user writes are limited to project state changes.
